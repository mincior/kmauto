...
@section('content')
    ...
    <form id="myForm" method="POST" action="{{ route('back.car-stats.update', [$car_stat->id]) }}" enctype="multipart/form-data">
        @csrf
            ...
            <div class="col-12">
                <div class="card mb-3">
                    <div class="card-header">
                        <div class="row">
                            <div id="myToolTip" class="col">CarStat modificare</div>
						 ...
						 <div class="row mb-2">
							 ...
							 <div class="col-md-3">
								 <input autocomplete="on" id="observatii" name="observatii" type="text" 
									 ...
									 value="{{ old('observatii') ? old('observatii') : $car_stat->observatii }}" >
						 ...
						 <div class="row mb-2">
							 ...
							 <div class="col-md-3">
								 <input autocomplete="on" id="interval_id" name="interval_id" type="text" 
									 ...
									 value="{{ old('interval_id') ? old('interval_id') : $car_stat->interval_id }}" >
						 ...
						 <div class="row mb-2">
							 ...
							 <div class="col-md-3">
								 <input autocomplete="on" id="car_id" name="car_id" type="text" 
									 ...
									 value="{{ old('car_id') ? old('car_id') : $car_stat->car_id }}" >
						 ...
						 <div class="row mb-2">
							 ...
							 <div class="col-md-3">
								 <input autocomplete="on" id="car_stat_value_id" name="car_stat_value_id" type="text" 
									 class="form-control @error('car_stat_value_id') is-invalid @enderror" 
									 value="{{ old('car_stat_value_id') ? old('car_stat_value_id') : $car_stat->car_stat_value_id }}" >
