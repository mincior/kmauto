        ...
        $(function() {
            ...
            let createButton = {
                ...
                action: function(e, dt, node, config) {
                    document.location.href = '{{ route('back.stats.create') }}';
                }
            }
            ...
            let showButton = {
                ...
                action: function(e, dt, node, config) {
                    ...
                    document.location.href = '{{ route('back.stats.show', 'id') }}'.replace("id", id);
                }
            }
            ...
            let editButton = {
                ...
                action: function(e, dt, node, config) {
                    ...
                    document.location.href = '{{ route('back.stats.edit', 'id') }}'.replace("id", id);
                }
            }
            ...
            let deleteButton = {
                ...
                titleAttr: 'Delete',
                enabled: false,
                url: "{{ route('back.stats.massDestroy') }}",
                action: function(e, dt, node, config) {
                    var ids = $.map(dt.rows({
                        selected: true
                    }).data(), function(entry) {
                                ...
                                $.ajax({
                                    ...
                                    success: function(response) {
                                        ...
                                        showToast({
                                            stat: 'success',
                                            title: 'Stergere ...',
                                            message: 'Statusul/statusii selectati au fost stersi!',
                                        });
                                    }
                                });
                            }
            ...
            let dtOverrideGlobals = {
                ...
                columns: [{
                        ...
                        searchable: false,
                        className: 'text-left',
                        render: function(data, stat, row, meta) {
            ...
            /* ------------------------------------------------------------------------ */
            oTable.on('select deselect', function(e, dt, stat, indexes) {
