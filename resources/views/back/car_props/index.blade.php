...
@section('content')
    <div class="card">
        ...
        <div class="card-body p-1">
            ...
            <table id="car_propTable" class="table table-bordered table-striped table-hover table-sm dataTable">
        ...
        $(function() {
            ...
            let createButton = {
                ...
                action: function(e, dt, node, config) {
                    document.location.href = '{{ route('back.car-props.create') }}';
                }
            }
            ...
            let showButton = {
                ...
                action: function(e, dt, node, config) {
                    ...
                    document.location.href = '{{ route('back.car-props.show', 'id') }}'.replace("id", id);
                }
            }
            ...
            let editButton = {
                ...
                action: function(e, dt, node, config) {
                    ...
                    document.location.href = '{{ route('back.car-props.edit', 'id') }}'.replace("id", id);
                }
            }
            ...
            let deleteButton = {
                ...
                titleAttr: 'Delete',
                enabled: false,
                url: "{{ route('back.car-props.massDestroy') }}",
                action: function(e, dt, node, config) {
                    var ids = $.map(dt.rows({
                        selected: true
                    }).data(), function(entry) {
            ...
            let dtOverrideGlobals = {
                ajax: {
                    url: "{{ route('back.car-props.index') }}",
                    data: function(d) {}
                },
                columns: [
            ...
            /* ------------------------------------------- */
            let oTable = $('#car_propTable').DataTable(dtOverrideGlobals);
            /* ------------------------------------------------------------------------ */
            ...
            // var table = $('#car_propTable').DataTable();
            // $('#car_propTable').on('click', 'tr', function() {
