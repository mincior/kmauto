...
@section('content')
    <?php
    ?>
    <form id="myForm" method="POST" action="{{ route('back.departments.store') }}" enctype="multipart/form-data">
        @csrf
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-3">
                                <input autocomplete="on" id="name" name="name" type="text"
                                    ...
                                    value="{{ old('name')}}" onkeyup="prelucrare_nume_filiala(this);">
