...
@section('content')
    ...
    <form id="myForm" method="POST" action="{{ route('back.carseconds.store') }}" enctype="multipart/form-data">
        @csrf
            ...
            <div class="col-12">
                <div class="card mb-3">
                    <div class="card-header">
                        <div class="row">
                            <div id="myToolTip" class="col">Carsecond adaugare</div>
                    ...
                    <div class="card-body">
						 ...
						 <div class="row mb-2">
							 ...
							 <div class="col-md-3">
								 ...
								 class="form-control @error('nr_identificare') is-invalid @enderror" value="{{ old('nr_identificare') }}">
						 ...
						 <div class="row mb-2">
							 ...
							 <div class="col-md-3">
								 ...
								 class="form-control @error('are_gps') is-invalid @enderror" value="{{ old('are_gps') }}">
						 ...
						 <div class="row mb-2">
							 ...
							 <div class="col-md-3">
								 ...
								 class="form-control @error('recep_auto') is-invalid @enderror" value="{{ old('recep_auto') }}">
						 ...
						 <div class="row mb-2">
							 ...
							 <div class="col-md-3">
								 ...
								 class="form-control @error('an_fabr') is-invalid @enderror" value="{{ old('an_fabr') }}">
						 ...
						 <div class="row mb-2">
							 ...
							 <div class="col-md-3">
								 ...
								 class="form-control @error('poluare') is-invalid @enderror" value="{{ old('poluare') }}">
						 ...
						 <div class="row mb-2">
							 ...
							 <div class="col-md-3">
								 ...
								 class="form-control @error('p_kw') is-invalid @enderror" value="{{ old('p_kw') }}">
						 ...
						 <div class="row mb-2">
							 ...
							 <div class="col-md-3">
								 ...
								 class="form-control @error('mtma') is-invalid @enderror" value="{{ old('mtma') }}">
						 ...
						 <div class="row mb-2">
							 ...
							 <div class="col-md-3">
								 ...
								 class="form-control @error('cap_cyl') is-invalid @enderror" value="{{ old('cap_cyl') }}">
						 ...
						 <div class="row mb-2">
							 ...
							 <div class="col-md-3">
								 ...
								 class="form-control @error('cap_rez') is-invalid @enderror" value="{{ old('cap_rez') }}">
						 ...
						 <div class="row mb-2">
							 ...
							 <div class="col-md-3">
								 ...
								 class="form-control @error('auto_inloc') is-invalid @enderror" value="{{ old('auto_inloc') }}">
						 ...
						 <div class="row mb-2">
							 ...
							 <div class="col-md-3">
								 ...
								 class="form-control @error('km_contract') is-invalid @enderror" value="{{ old('km_contract') }}">
						 ...
						 <div class="row mb-2">
							 ...
							 <div class="col-md-3">
								 ...
								 class="form-control @error('caroseria') is-invalid @enderror" value="{{ old('caroseria') }}">
						 ...
						 <div class="row mb-2">
							 ...
							 <div class="col-md-3">
								 ...
								 class="form-control @error('frame_id') is-invalid @enderror" value="{{ old('frame_id') }}">
