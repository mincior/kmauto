        ...
        $(function() {
            ...
            let createButton = {
                ...
                action: function(e, dt, node, config) {
                    document.location.href = '{{ route('back.types.create') }}';
                }
            }
            ...
            let showButton = {
                ...
                action: function(e, dt, node, config) {
                    ...
                    document.location.href = '{{ route('back.types.show', 'id') }}'.replace("id", id);
                }
            }
            ...
            let editButton = {
                ...
                action: function(e, dt, node, config) {
                    ...
                    document.location.href = '{{ route('back.types.edit', 'id') }}'.replace("id", id);
                }
            }
            ...
            let deleteButton = {
                ...
                titleAttr: 'Delete',
                enabled: false,
                url: "{{ route('back.types.massDestroy') }}",
                action: function(e, dt, node, config) {
                    var ids = $.map(dt.rows({
                        selected: true
                    }).data(), function(entry) {
