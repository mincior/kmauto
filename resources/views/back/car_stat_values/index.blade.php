...
@section('content')
    <div class="card">
        <div class="card-header d-print-none">
            <div class="row">
                <div class="col">CarStatValues</div>
        ...
        <div class="card-body p-1">
            ...
            <table id="car_stat_valueTable" class="table table-bordered table-striped table-hover table-sm dataTable">
        ...
        $(function() {
            ...
            let createButton = {
                ...
                action: function(e, dt, node, config) {
                    document.location.href = '{{ route('back.car-stat-values.create') }}';
                }
            }
            ...
            let showButton = {
                ...
                action: function(e, dt, node, config) {
                    ...
                    document.location.href = '{{ route('back.car-stat-values.show', 'id') }}'.replace("id", id);
                }
            }
            ...
            let editButton = {
                ...
                action: function(e, dt, node, config) {
                    ...
                    document.location.href = '{{ route('back.car-stat-values.edit', 'id') }}'.replace("id", id);
                }
            }
            ...
            let deleteButton = {
                ...
                titleAttr: 'Delete',
                enabled: false,
                url: "{{ route('back.car-stat-values.massDestroy') }}",
                action: function(e, dt, node, config) {
                    var ids = $.map(dt.rows({
                        selected: true
                    }).data(), function(entry) {
            ...
            let dtOverrideGlobals = {
                ajax: {
                    url: "{{ route('back.car-stat-values.index') }}",
                    data: function(d) {}
                },
                columns: [
            ...
            /* ------------------------------------------- */
            let oTable = $('#car_stat_valueTable').DataTable(dtOverrideGlobals);
            /* ------------------------------------------------------------------------ */
            ...
            // var table = $('#car_stat_valueTable').DataTable();
            // $('#car_stat_valueTable').on('click', 'tr', function() {
