...
@section('content')
    <?php
    ?>
    <form id="myForm" method="POST" action="{{ route('back.brands.store') }}" enctype="multipart/form-data">
        @csrf
            ...
            <div class="col-12">
                <div class="card mb-3">
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col">
                                <a class="btn btn-secondary text-white btn-sm" href="{{ route('back.brands.index') }}"
