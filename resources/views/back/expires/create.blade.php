...
@section('content')
    ...
    <form id="myForm" method="POST" action="{{ route('back.expires.store') }}" enctype="multipart/form-data">
        @csrf
            ...
            <div class="col-12">
                <div class="card mb-3">
                    <div class="card-header">
                        <div class="row">
                            <div id="myToolTip" class="col">Expire adaugare</div>
                    ...
                    <div class="card-body">
						 ...
						 <div class="row mb-2">
							 ...
							 <div class="col-md-3">
								 ...
								 class="form-control @error('casco') is-invalid @enderror" value="{{ old('casco') }}">
						 ...
						 <div class="row mb-2">
							 ...
							 <div class="col-md-3">
								 ...
								 class="form-control @error('rca') is-invalid @enderror" value="{{ old('rca') }}">
						 ...
						 <div class="row mb-2">
							 ...
							 <div class="col-md-3">
								 ...
								 class="form-control @error('rovinieta') is-invalid @enderror" value="{{ old('rovinieta') }}">
						 ...
						 <div class="row mb-2">
							 ...
							 <div class="col-md-3">
								 ...
								 class="form-control @error('itp') is-invalid @enderror" value="{{ old('itp') }}">
						 ...
						 <div class="row mb-2">
							 ...
							 <div class="col-md-3">
								 ...
								 class="form-control @error('final_leasing') is-invalid @enderror" value="{{ old('final_leasing') }}">
