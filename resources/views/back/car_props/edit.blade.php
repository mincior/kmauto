...
@section('content')
    ...
    <form id="myForm" method="POST" action="{{ route('back.car-props.update', [$car_prop->id]) }}" enctype="multipart/form-data">
        @csrf
						 ...
						 <div class="row mb-2">
							 ...
							 <div class="col-md-3">
								 <input autocomplete="on" id="observatii" name="observatii" type="text" 
									 ...
									 value="{{ old('observatii') ? old('observatii') : $car_prop->observatii }}" >
						 ...
						 <div class="row mb-2">
							 ...
							 <div class="col-md-3">
								 <input autocomplete="on" id="interval_id" name="interval_id" type="text" 
									 ...
									 value="{{ old('interval_id') ? old('interval_id') : $car_prop->interval_id }}" >
						 ...
						 <div class="row mb-2">
							 ...
							 <div class="col-md-3">
								 <input autocomplete="on" id="car_id" name="car_id" type="text" 
									 ...
									 value="{{ old('car_id') ? old('car_id') : $car_prop->car_id }}" >
						 ...
						 <div class="row mb-2">
							 ...
							 <div class="col-md-3">
								 <input autocomplete="on" id="car_prop_value_id" name="car_prop_value_id" type="text" 
									 class="form-control @error('car_prop_value_id') is-invalid @enderror" 
									 value="{{ old('car_prop_value_id') ? old('car_prop_value_id') : $car_prop->car_prop_value_id }}" >
