...
?>
<form id="myForm" method="POST" action="{{ route('back.users.update', [$user->id])  }}" enctype="multipart/form-data" wire:submit.prevent="savePersonalData" onkeydown="return event.key != 'Enter';">
    @csrf
    @method('PUT')
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="row mb-2">
                        ...
                        <div class="col-md-3">
                            <input autocomplete="on" id="name" name="name" type="text" class="form-control @error('name') is-invalid @enderror" value="{{ $car->name }}">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-3">
                            <select name="activ" id="activ_select" class="form-select">
                                <option value="">Alege ...</option>
                                <option   {{ (old('activ') ?   (old('activ') == "1") : ($user->activ == 1)) ? "selected" : "" }}  value="1">Da</option>
                                <option   {{ (old('activ') ?   (old('activ') == "0") : ($user->activ == 0)) ? "selected" : "" }}  value="0">Nu</option>
                            </select>
                        </div>
                    </div>
                </div>
