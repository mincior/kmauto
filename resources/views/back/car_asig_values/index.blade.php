...
@section('content')
    <div class="card">
        <div class="card-header d-print-none">
            <div class="row">
                <div class="col">CarAsigValues</div>
        ...
        <div class="card-body p-1">
            ...
            <table id="car_asig_valueTable" class="table table-bordered table-striped table-hover table-sm dataTable">
        ...
        $(function() {
            ...
            let createButton = {
                ...
                action: function(e, dt, node, config) {
                    document.location.href = '{{ route('back.car-asig-values.create') }}';
                }
            }
            ...
            let showButton = {
                ...
                action: function(e, dt, node, config) {
                    ...
                    document.location.href = '{{ route('back.car-asig-values.show', 'id') }}'.replace("id", id);
                }
            }
            ...
            let editButton = {
                ...
                action: function(e, dt, node, config) {
                    ...
                    document.location.href = '{{ route('back.car-asig-values.edit', 'id') }}'.replace("id", id);
                }
            }
            ...
            let deleteButton = {
                ...
                titleAttr: 'Delete',
                enabled: false,
                url: "{{ route('back.car-asig-values.massDestroy') }}",
                action: function(e, dt, node, config) {
                    var ids = $.map(dt.rows({
                        selected: true
                    }).data(), function(entry) {
            ...
            let dtOverrideGlobals = {
                ajax: {
                    url: "{{ route('back.car-asig-values.index') }}",
                    data: function(d) {}
                },
                columns: [
            ...
            /* ------------------------------------------- */
            let oTable = $('#car_asig_valueTable').DataTable(dtOverrideGlobals);
            /* ------------------------------------------------------------------------ */
            ...
            // var table = $('#car_asig_valueTable').DataTable();
            // $('#car_asig_valueTable').on('click', 'tr', function() {
