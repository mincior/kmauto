        ...
        <div class="col-12">
            <div class="card mb-3">
                <div class="card-header">
                    <div class="row">
                        <div id="myToolTip" class="col">CarStats</div>
                ...
                <div class="card-body">
					 ...
					 <div class="row mb-2">
						 ...
						 <div class="col-md-8">
							 <input id="car_stat_value_id" name="car_stat_value_id" type="text" readonly class="form-control-plaintext"
								 value="{{ $car_stat->car_stat_value_id }}">
						 </div>
					 </div>
