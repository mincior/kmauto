...
@section('content')
    <?php
    ?>
    <form id="myForm" method="POST" action="{{ route('back.months.update', $month->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div class="col-12">
                <div class="card mb-3">
                    <div class="card-header">
                        <div class="row">
                            <div id="myToolTip" class="col">Luni modificare</div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-3">
                                <input autocomplete="on" id="anul_luna" name="anul_luna" type="text"
                                    ...
                                    value="{{ old('anul_luna') ?  old('anul_luna') : $month->anul_luna }}">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-3">
                                <select name="select" id="select_select" class="form-select">
                                    ...
                                    <option   {{ (old('select') ?   (old('select') == "1") : ($month->select == 1)) ? "selected" : "" }}  value="1">Da</option>
                                    <option   {{ (old('select') ?   (old('select') == "0") : ($month->select == 0)) ? "selected" : "" }}  value="0">Nu</option>
                                </select>
                            </div>
                        </div>
                        <div class="row mb-2">
                            ...
                            <div class="col-md-3">
                                <select name="inchisa" id="inchisa_select" class="form-select">
                                    <option value="">Alege ...</option>
                                    <option   {{ (old('inchisa') ?   (old('inchisa') == "1") : ($month->inchisa == 1)) ? "selected" : "" }}  value="1">Da</option>
                                    <option   {{ (old('inchisa') ?   (old('inchisa') == "0") : ($month->inchisa == 0)) ? "selected" : "" }}  value="0">Nu</option>
                                </select>
                            </div>
                        </div>
