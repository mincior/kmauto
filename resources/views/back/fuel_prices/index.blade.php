        ...
        $(function() {
            ...
            let createButton = {
                ...
                action: function(e, dt, node, config) {
                    document.location.href = '{{ route('back.fuel-prices.create') }}';
                }
            }
            ...
            let showButton = {
                ...
                action: function(e, dt, node, config) {
                    ...
                    document.location.href = '{{ route('back.fuel-prices.show', 'id') }}'.replace("id", id);
                }
            }
            ...
            let editButton = {
                ...
                action: function(e, dt, node, config) {
                    ...
                    document.location.href = '{{ route('back.fuel-prices.edit', 'id') }}'.replace("id", id);
                }
            }
            ...
            let deleteButton = {
                ...
                titleAttr: 'Delete',
                enabled: false,
                url: "{{ route('back.fuel-prices.massDestroy') }}",
                action: function(e, dt, node, config) {
                    var ids = $.map(dt.rows({
                        selected: true
                    }).data(), function(entry) {
                                ...
                                $.ajax({
                                    ...
                                    success: function(response) {
                                        ...
                                        showToast({
                                            type: 'success',
                                            title: 'Stergere ...',
                                            message: 'Pretul/Preturile la combustibil selectate au fost sterse!',
                                        });
                                    }
                                });
                            }
            ...
            let dtOverrideGlobals = {
                ajax: {
                    url: "{{ route('back.fuel-prices.index') }}",
                    data: function(d) {}
                },
                columns: [{
                        data: 'id',
